 ...
 * @author 1gdaw09
 */
public class vCasoEliminado extends javax.swing.JFrame {

    /**
     * Creates new form vCasoAlta
     */
    public vCasoEliminado() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vCasoEliminado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vCasoEliminado().setVisible(true);
            }
        });
    }
